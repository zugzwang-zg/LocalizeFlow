...
- Claim coverage must include every capacity and product-type expression at that location. When one claim contains a name, product type, capacity, ingredient, or benefit, cite every eligible fact needed to support all of those parts; a product-name fact alone does not support an added product type or size.
